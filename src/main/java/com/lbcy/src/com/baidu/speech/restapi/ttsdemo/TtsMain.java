package com.lbcy.src.com.baidu.speech.restapi.ttsdemo;

import com.lbcy.src.com.baidu.speech.restapi.common.ConnUtil;
import com.lbcy.src.com.baidu.speech.restapi.common.DemoException;
import com.lbcy.src.com.baidu.speech.restapi.common.TokenHolder;
...
//    private final String appKey = "4E1BG9lTnlSeIf1NQFlrSq6h";
    private final String appKey = "mvLTcn8uGGbOK25OWBMxjlI2";

    // 填写网页上申请的APP SECRET 如 $secretKey="94dc99566550d87f8fa8ece112xxxxx"
//    private final String secretKey = "544ca4657ba8002e3dea3ac2f5fdd241";
    private final String secretKey = "5MhoTc9N4d4hBqiQ4Qc5FZBABrps24me";

    // 填写网页上申请的APP SECRET 如 $secretKey="94dc99566550d87f8fa8ece112xxxxx"

    // text 的内容为"欢迎使用百度语音合成"的urlencode,utf-8 编码
    // 可以百度搜索"urlencode"
    private final String text = " 您已成功收取10元，您已成功收取34元，您已成功收取2.3元";
